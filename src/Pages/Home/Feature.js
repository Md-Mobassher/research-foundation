    ...
    return (
        <div id='feature' className='my-12 border-b-2 border-black '>
            <div className='lg:px-20 mx-auto grid grid-cols-1 lg:grid-cols-3 gap-2'>
                <div className=' border-l-2  border-black p-10 hover:-translate-y-5 translate-y-12 overflow-hidden hover:btn-block'>
                    <div>
                    ...
                    <button class="btn btn-info btn-sm mt-4 hidden  ">Click Here</button>
                </div>
